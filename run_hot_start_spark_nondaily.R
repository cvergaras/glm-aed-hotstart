...
round_num <- 30
file.copy("glm3_initial_spark_nondaily.nml", "glm3.nml", overwrite = TRUE)
file.copy("glm3_initial_spark_nondaily.nml", "glm3_full.nml", overwrite = TRUE)
full_time <- seq(as_datetime("1997-04-16 00:00:00"), as_datetime("1997-10-20 00:00:00"), "1 day")
...
#   system2("/workspaces/focal_py39/AED_Tools/binaries/ubuntu/20.04/glm_latest/glm", stdout = paste0("txt/output", i, ".txt"))
  system2("/workspaces/focal_py39/2025/AED_Tools_Private/binaries/ubuntu/20.04/glm+_latest/glm+", stdout = paste0("txt/output", i, ".txt"))
...
system2("/workspaces/focal_py39/2025/AED_Tools_Private/binaries/ubuntu/20.04/glm+_latest/glm+", args = "--nml glm3_full.nml", stdout = "output.txt")
